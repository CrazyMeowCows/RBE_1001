...
def pickup_fruit(tree_distance, tree_height):
    calibrate_robot()
    line_follow_dist_cm(tree_distance, 60)
    set_arm("turn", 0)
    gyro_turn(-90, 50)
    reverse_to_wall(8, 20)
    set_arm(tree_height, 100)
    sleep(500)
    if (tree_height == "tree_3"):
        drive_forward(10, 25)
        sleep(500)
    find_fruit()
    gyro_turn(-90, 50)
    ...
    set_arm("travel", 0)
    gyro_turn(-180, 50)
    line_follow_dist_cm(tree_distance-11, 60)
    gyro_turn(-90, 50)
    set_arm("travel", -30)
    sleep(3000)
    set_arm("travel", 0)
